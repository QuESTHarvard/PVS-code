...
ipacheckspecifyrecode using "$in_out/Input/specifyrecode_inputs/specifyrecode_inputs_15.xlsm",	///
...
save "$data_mc/02 recoded data/input data files/pvs_kr.dta", replace
